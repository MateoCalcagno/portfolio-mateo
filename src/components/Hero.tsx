...
export default function Hero() {
  return (
    <section id="hero" className="relative min-h-screen flex flex-col justify-center px-8 overflow-hidden bg-slate-950 py-16">
      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-10 items-center relative z-10">
        ...
        >
          <span className="self-start px-4 py-1.5 rounded-full border border-cyan-500/30 bg-cyan-950/40 text-cyan-400 font-bold text-[12px] tracking-[0.2em] uppercase">
            Portfolio Personal
          </span>
          ...
          <p className="text-gray-300 max-w-xl text-lg md:text-xl leading-relaxed border-l-2 border-cyan-500/30 pl-6">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            <a 
              href="#projects" 
              className="bg-cyan-500 text-slate-950 px-8 py-3.5 rounded-2xl font-bold flex items-center gap-2 hover:bg-cyan-400 transition-all text-sm uppercase tracking-widest shadow-lg shadow-cyan-500/20"
            >
              Ver Proyectos
            </a>
            ...
            <a
              ...
              download
              className="relative overflow-hidden border border-white/10 text-white/80 px-8 py-3.5 rounded-2xl font-bold hover:bg-white/5 hover:text-white transition-all flex items-center gap-2 group text-sm uppercase tracking-widest"
            >
        ...
        >
          ...
          <div className="p-7 bg-slate-900/50 backdrop-blur-2xl rounded-[2rem] border border-white/5 space-y-4 shadow-2xl">
          ...
          <div className="p-7 bg-slate-900/50 rounded-[2rem] border border-white/5 hover:border-cyan-500/20 transition-colors">
